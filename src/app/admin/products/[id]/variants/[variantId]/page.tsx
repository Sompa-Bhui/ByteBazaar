...
export default async function EditVariantPage({ params }: { params: { id: string; variantId: string } }) {
  ...
  const initial = {
    ...
    inventory: variant.inventory ? { quantityOnHand: variant.inventory.quantityOnHand, safetyStock: variant.inventory.safetyStock, location: variant.inventory.location } : undefined,
  };
